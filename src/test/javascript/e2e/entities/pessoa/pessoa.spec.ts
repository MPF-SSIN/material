...
describe('Pessoa e2e test', () => {
  ...
  it('should load Pessoas', async () => {
    ...
    expect(await pessoaComponentsPage.getTitle()).to.eq('ssinApp.pessoa.home.title');
  ...
  it('should load create Pessoa page', async () => {
    ...
    expect(await pessoaUpdatePage.getPageTitle()).to.eq('ssinApp.pessoa.home.createOrEditLabel');
  ...
  it('should create and save Pessoas', async () => {
    ...
    await promise.all([
      ...
      pessoaUpdatePage.tipoVinculoSelectLastOption(),
  ...
  it('should delete last Pessoa', async () => {
    ...
    expect(await pessoaDeleteDialog.getDialogTitle()).to.eq('ssinApp.pessoa.delete.question');
