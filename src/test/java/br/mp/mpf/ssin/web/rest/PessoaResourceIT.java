...
import br.mp.mpf.ssin.domain.Pessoa;
import br.mp.mpf.ssin.repository.PessoaRepository;
...
public class PessoaResourceIT {
    ...
    private static final TipoVinculo DEFAULT_TIPO_VINCULO = TipoVinculo.MEMBRO;
    private static final TipoVinculo UPDATED_TIPO_VINCULO = TipoVinculo.SERVIDOR;
    ...
    public void createPessoa() throws Exception {
        ...
        assertThat(testPessoa.getTipoVinculo()).isEqualTo(DEFAULT_TIPO_VINCULO);
    ...
    @Test
    @Transactional
    public void checkTipoVinculoIsRequired() throws Exception {
        int databaseSizeBeforeTest = pessoaRepository.findAll().size();
        // set the field null
        pessoa.setTipoVinculo(null);
    ...
    public void updatePessoa() throws Exception {
        ...
        assertThat(testPessoa.getTipoVinculo()).isEqualTo(UPDATED_TIPO_VINCULO);
