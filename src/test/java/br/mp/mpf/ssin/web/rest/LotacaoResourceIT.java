...
import br.mp.mpf.ssin.repository.LotacaoRepository;
...
public class LotacaoResourceIT {
    ...
    private static final Boolean DEFAULT_PROPRIA = false;
    private static final Boolean UPDATED_PROPRIA = true;
    ...
    public void createLotacao() throws Exception {
        ...
        assertThat(testLotacao.isPropria()).isEqualTo(DEFAULT_PROPRIA);
    }
    ...
    public void getAllLotacaos() throws Exception {
        ...
        restLotacaoMockMvc.perform(get("/api/lotacaos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].propria").value(hasItem(DEFAULT_PROPRIA.booleanValue())));
    }
    ...
    public void getLotacao() throws Exception {
        ...
        restLotacaoMockMvc.perform(get("/api/lotacaos/{id}", lotacao.getId()))
            ...
            .andExpect(jsonPath("$.propria").value(DEFAULT_PROPRIA.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateLotacao() throws Exception {
        ...
        assertThat(testLotacao.isPropria()).isEqualTo(UPDATED_PROPRIA);
    }
